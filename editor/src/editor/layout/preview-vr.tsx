...
export interface IEditorPreviewVRProps {
	/**
...
export interface IEditorPreviewVRState {
	/**
...
export class EditorPreviewVR extends Component<IEditorPreviewVRProps, IEditorPreviewVRState> {
	/**
	...
	public constructor(props: IEditorPreviewVRProps) {
		super(props);
