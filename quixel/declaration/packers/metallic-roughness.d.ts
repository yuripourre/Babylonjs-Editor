...
export declare class MetallicRoughnessPacker {
    /**
     ...
     */
    static Pack(editor: Editor, material: PBRMaterial, metallicTexture: Texture | null, roughnessTexture: Texture | null, rootFolder: string): Promise<void>;
}
